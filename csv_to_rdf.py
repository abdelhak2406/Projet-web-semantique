...
for i,j  in fiche.iterrows():
    ...
    fi.creer_fiche(j["id_patient"], j["id_medecin"], j["age"], j["taille"], j["sexe"], j["poid"], j["wilaya_patient"], j["daira_patient"], symptomes=j["sympthomes"], 
    maladies=j["Maladie(diagnostique)"], traitements=j["traitement"], j["nb_jrs_depuis_derniere_sortie"], j["nb_jrs_depuis_premiers_sympthomes"], j["date"], j["specialite_medecin"], 
    j["nom medecin"], j["prenom medecin"] )
