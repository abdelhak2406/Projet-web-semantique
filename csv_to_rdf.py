...
for i,j  in fiche.iterrows():
    ...
    medec.creer_medecin(id=j["id_medecin"],sexe="Homme",specialite=j["specialite_medecin"],nom=j["nom medecin"],prenom=j["prenom medecin"],
    consultation=co.objet_consultation)
